  ...
  return (
    <div className={className}>
      ...
      <div className='cse-intro-box'>
        <p className='first-para-small'>The department focuses on creating skilled professionals, preparing students for industry, and developing their skills.</p>
      ...
      <div className='vision-content'>
        <p>To provide quality technical education in the field of Computer Science and Engineering by keeping pace with emerging technology to create competent professional</p>
      </div>
      ...
      <div className='mission-content'>
        <ul>
          ...
          <li>To fulfill the expectations of society by creating resourceful and responsible engineer.</li>
        </ul>
      </div>
