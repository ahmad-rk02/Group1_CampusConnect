    ...
    const fetchFaculty = async () => {
      try {
        const [res1, res2, res3, res4] = await Promise.all([
          axios.get(`${API_BASE_URL}/instrumentation-hod?populate=*`),
          axios.get(`${API_BASE_URL}/instru-faculties?populate=*`),
          axios.get(`${API_BASE_URL}/instru-non-teaching-faculties?populate=*`),
          axios.get(`${API_BASE_URL}/instru-visiting-faculties?populate=*`),
        ]);
