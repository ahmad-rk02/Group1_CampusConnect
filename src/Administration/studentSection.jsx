                  ...
                  <div className="member-details">
                    ...
                    <div className="member-info">
                      ...
                      <span className="info-value description">
                        {expanded[`${section.id}-education`] || section.education.length <= 50
                          ? section.education
                          : `${section.education.substring(0, 50)}...`}
                        {section.education.length > 50 && (
                          <button
                            className="read-more-btn"
                            onClick={() => toggleExpand(section.id, "education")}
                          >
                            {expanded[`${section.id}-education`] ? "Read Less" : "Read More"}
                          </button>
                        )}
                      </span>
                    </div>
