    ...
    const fetchFaculty = async () => {
      try {
        const [res1, res2, res3, res4] = await Promise.all([
          axios.get(`${API_BASE_URL}/api/science-and-humanities-hod
?populate=*`),
          axios.get(`${API_BASE_URL}/api/science-and-humanities-faculties
?populate=*`),
          axios.get(`${API_BASE_URL}/api/science-and-humanities-non-teaching-faculties
?populate=*`),
          axios.get(`${API_BASE_URL}/api/science-and-humanities-visiting-faculties
?populate=*`),
        ]);
